...
@WebServlet(name = "OveruseServlet", urlPatterns = {"/report/overuse"})
public class OveruseServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            try {
                ...
                // invoke controller
                OveruseResult overuseResult = OveruseController.computeBasicReport(startDate, endDate, user.getEmail(),
                        conn);

                request.setAttribute("overuseResult", overuseResult);
                request.getRequestDispatcher("/WEB-INF/jsp/overuse.jsp").forward(request, response);
