...
@WebServlet(name = "SmartphoneUsageHeatmapServlet", urlPatterns = {"/report/smartphone-usage-heatmap"})
public class SmartphoneUsageHeatmapServlet extends HttpServlet {
        ...
        try {
            ...
            try {
                ...
                ArrayList<HeatmapResult> heatmapResults
                        = LocationUpdateDAO.getSmartphoneUsageHeatmapResult(date, floor, conn);

                request.setAttribute("heatmapResults", heatmapResults);
