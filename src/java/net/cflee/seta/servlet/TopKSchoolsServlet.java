...
@WebServlet(name = "TopKSchoolsServlet", urlPatterns = {"/report/topk-schools"})
public class TopKSchoolsServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                ArrayList<TopKResult> results = TopKController.computeSchools(startDate, endDate, appCategory, k, conn);

                request.setAttribute("topKSchoolResults", results);
                request.getRequestDispatcher("/WEB-INF/jsp/topk-schools.jsp").forward(request, response);
