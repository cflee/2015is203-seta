...
@WebServlet(name = "BasicTimeCategoryServlet", urlPatterns = {"/report/basic-time-category"})
public class BasicTimeCategoryServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            try {
                ...
                BasicAppUsageTimeCategoryResult results = BasicAppUsageController
                        .computeTimeCategory(startDate, endDate, conn);

                request.setAttribute("basicTimeCategoryResults", results);
                request.getRequestDispatcher("/WEB-INF/jsp/basic-time-category.jsp").forward(request, response);
