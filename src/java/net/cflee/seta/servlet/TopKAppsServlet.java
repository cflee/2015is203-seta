...
@WebServlet(name = "TopKAppsServlet", urlPatterns = {"/report/topk-apps"})
public class TopKAppsServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                ArrayList<TopKResult> results = TopKController.computeApps(startDate, endDate, school, k, conn);

                request.setAttribute("topKAppResults", results);
                request.getRequestDispatcher("/WEB-INF/jsp/topk-apps.jsp").forward(request, response);
