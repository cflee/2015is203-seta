...
@WebServlet(name = "BasicAppCategoryServlet", urlPatterns = {"/report/basic-app-category"})
public class BasicAppCategoryServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            try {
                ...
                ArrayList<AppUsageTimeResult> results = BasicAppUsageController
                        .computeAppCategory(startDate, endDate, conn);

                request.setAttribute("basicAppCategoryResults", results);
                request.getRequestDispatcher("/WEB-INF/jsp/basic-app-category.jsp").forward(request, response);
