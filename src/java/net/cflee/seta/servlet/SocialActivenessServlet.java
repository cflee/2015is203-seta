...
import net.cflee.seta.controller.SocialActivenessController;
...
@WebServlet(name = "SocialActivenessServlet", urlPatterns = {"/report/social-activeness"})
public class SocialActivenessServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            try {
                ...
                // invoke controller
                SocialActivenessResult socialActivenessResult
                        = SocialActivenessController.computeReport(date, user.getEmail(), conn);

                request.setAttribute("socialActivenessResult", socialActivenessResult);
                request.getRequestDispatcher("/WEB-INF/jsp/social-activeness.jsp").forward(request, response);
